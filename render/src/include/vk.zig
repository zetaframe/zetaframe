...
pub const HEADER_VERSION = 143;
pub const HEADER_VERSION_COMPLETE = makeVersion(1, 2, HEADER_VERSION);
pub const Display = if (@hasDecl(root, "Display")) root.Display else @Type(.Opaque);
...
pub const wl_display = if (@hasDecl(root, "wl_display")) root.wl_display else @Type(.Opaque);
pub const wl_surface = if (@hasDecl(root, "wl_surface")) root.wl_surface else @Type(.Opaque);
pub const HINSTANCE = if (@hasDecl(root, "HINSTANCE")) root.HINSTANCE else std.os.HINSTANCE;
pub const HWND = if (@hasDecl(root, "HWND")) root.HWND else *@Type(.Opaque);
pub const HMONITOR = if (@hasDecl(root, "HMONITOR")) root.HMONITOR else *@Type(.Opaque);
...
pub const ANativeWindow = @Type(.Opaque);
pub const AHardwareBuffer = @Type(.Opaque);
pub const CAMetalLayer = @Type(.Opaque);
...
pub const GeometryFlagsNV = GeometryFlagsNV;
pub const GeometryInstanceFlagsNV = GeometryInstanceFlagsNV;
pub const BuildAccelerationStructureFlagsNV = BuildAccelerationStructureFlagsNV;
...
pub const AccelerationStructureNV = AccelerationStructureNV;
...
pub const Win32SurfaceCreateInfoKHR = extern struct {
    s_type: StructureType = .win_32_surface_create_info_khr,
    p_next: ?*const c_void = null,
...
pub const ImagePipeSurfaceCreateInfoFUCHSIA = extern struct {
    s_type: StructureType = .image_pipe_surface_create_info_fuchsia,
    p_next: ?*const c_void = null,
...
pub const ImportMemoryWin32HandleInfoNV = extern struct {
    s_type: StructureType = .import_memory_win_32_handle_info_nv,
    p_next: ?*const c_void = null,
    handle_type: ExternalMemoryHandleTypeFlags,
    handle: HANDLE,
};
pub const ExportMemoryWin32HandleInfoNV = extern struct {
    s_type: StructureType = .export_memory_win_32_handle_info_nv,
    p_next: ?*const c_void = null,
    p_attributes: ?*const SECURITY_ATTRIBUTES,
    dw_access: DWORD,
};
pub const Win32KeyedMutexAcquireReleaseInfoNV = extern struct {
    s_type: StructureType = .win_32_keyed_mutex_acquire_release_info_nv,
    p_next: ?*const c_void = null,
    acquire_count: u32,
...
pub const ImportMemoryWin32HandleInfoKHR = extern struct {
    s_type: StructureType = .import_memory_win_32_handle_info_khr,
    p_next: ?*const c_void = null,
    handle_type: ExternalMemoryHandleTypeFlags,
    handle: HANDLE,
    name: LPCWSTR,
...
pub const ExportMemoryWin32HandleInfoKHR = extern struct {
    s_type: StructureType = .export_memory_win_32_handle_info_khr,
    p_next: ?*const c_void = null,
    p_attributes: ?*const SECURITY_ATTRIBUTES,
    dw_access: DWORD,
    name: LPCWSTR,
...
pub const MemoryWin32HandlePropertiesKHR = extern struct {
    s_type: StructureType = .memory_win_32_handle_properties_khr,
    p_next: ?*c_void = null,
    memory_type_bits: u32,
};
pub const MemoryGetWin32HandleInfoKHR = extern struct {
    s_type: StructureType = .memory_get_win_32_handle_info_khr,
    p_next: ?*const c_void = null,
    memory: DeviceMemory,
    handle_type: ExternalMemoryHandleTypeFlags,
};
...
pub const Win32KeyedMutexAcquireReleaseInfoKHR = extern struct {
    s_type: StructureType = .win_32_keyed_mutex_acquire_release_info_khr,
    p_next: ?*const c_void = null,
    acquire_count: u32,
    p_acquire_syncs: [*]const DeviceMemory,
    p_acquire_keys: [*]const u64,
...
pub const ImportSemaphoreWin32HandleInfoKHR = extern struct {
    s_type: StructureType = .import_semaphore_win_32_handle_info_khr,
    p_next: ?*const c_void = null,
    semaphore: Semaphore,
...
pub const ExportSemaphoreWin32HandleInfoKHR = extern struct {
    s_type: StructureType = .export_semaphore_win_32_handle_info_khr,
    p_next: ?*const c_void = null,
    p_attributes: ?*const SECURITY_ATTRIBUTES,
    dw_access: DWORD,
    name: LPCWSTR,
...
pub const SemaphoreGetWin32HandleInfoKHR = extern struct {
    s_type: StructureType = .semaphore_get_win_32_handle_info_khr,
    p_next: ?*const c_void = null,
    semaphore: Semaphore,
    handle_type: ExternalSemaphoreHandleTypeFlags,
};
...
pub const ImportFenceWin32HandleInfoKHR = extern struct {
    s_type: StructureType = .import_fence_win_32_handle_info_khr,
    p_next: ?*const c_void = null,
    fence: Fence,
...
pub const ExportFenceWin32HandleInfoKHR = extern struct {
    s_type: StructureType = .export_fence_win_32_handle_info_khr,
    p_next: ?*const c_void = null,
    p_attributes: ?*const SECURITY_ATTRIBUTES,
    dw_access: DWORD,
    name: LPCWSTR,
...
pub const FenceGetWin32HandleInfoKHR = extern struct {
    s_type: StructureType = .fence_get_win_32_handle_info_khr,
    p_next: ?*const c_void = null,
    fence: Fence,
    handle_type: ExternalFenceHandleTypeFlags,
};
...
pub const MacOSSurfaceCreateInfoMVK = extern struct {
    s_type: StructureType = .mac_os_surface_create_info_mvk,
    p_next: ?*const c_void = null,
...
pub const PhysicalDevice16BitStorageFeatures = extern struct {
    s_type: StructureType = .physical_device_16_bit_storage_features,
    p_next: ?*c_void = null,
...
pub const PhysicalDeviceShaderFloat16Int8Features = extern struct {
    s_type: StructureType = .physical_device_shader_float_16_int_8_features,
    p_next: ?*c_void = null,
...
pub const PhysicalDevice8BitStorageFeatures = extern struct {
    s_type: StructureType = .physical_device_8_bit_storage_features,
    p_next: ?*c_void = null,
...
pub const PhysicalDeviceShaderAtomicInt64Features = extern struct {
    s_type: StructureType = .physical_device_shader_atomic_int_64_features,
    p_next: ?*c_void = null,
...
pub const BindAccelerationStructureMemoryInfoNV = BindAccelerationStructureMemoryInfoNV;
...
pub const WriteDescriptorSetAccelerationStructureNV = WriteDescriptorSetAccelerationStructureNV;
...
pub const PhysicalDeviceRayTracingFeaturesKHR = extern struct {
    ...
    p_next: ?*c_void = null,
    ray_tracing: Bool32,
    ray_tracing_shader_group_handle_capture_replay: Bool32,
    ray_tracing_shader_group_handle_capture_replay_mixed: Bool32,
    ray_tracing_acceleration_structure_capture_replay: Bool32,
    ray_tracing_indirect_trace_rays: Bool32,
    ray_tracing_indirect_acceleration_structure_build: Bool32,
    ray_tracing_host_acceleration_structure_commands: Bool32,
    ray_query: Bool32,
    ray_tracing_primitive_culling: Bool32,
};
...
pub const PhysicalDeviceBufferAddressFeaturesEXT = PhysicalDeviceBufferDeviceAddressFeatures;
...
pub const PhysicalDeviceTextureCompressionASTCHDRFeaturesEXT = extern struct {
    s_type: StructureType = .physical_device_texture_compression_astchdr_features_ext,
    p_next: ?*c_void = null,
...
pub const SurfaceFullScreenExclusiveWin32InfoEXT = extern struct {
    s_type: StructureType = .surface_full_screen_exclusive_win_32_info_ext,
    p_next: ?*const c_void = null,
    hmonitor: HMONITOR,
};
...
pub const PhysicalDeviceIndexTypeUint8FeaturesEXT = extern struct {
    s_type: StructureType = .physical_device_index_type_uint_8_features_ext,
    p_next: ?*c_void = null,
...
pub const PhysicalDeviceVulkan11Features = extern struct {
    s_type: StructureType = .physical_device_vulkan_11_features,
    p_next: ?*c_void = null,
    storage_buffer_16_bit_access: Bool32,
    uniform_and_storage_buffer_16_bit_access: Bool32,
    storage_push_constant_16: Bool32,
...
pub const PhysicalDeviceVulkan11Properties = extern struct {
    s_type: StructureType = .physical_device_vulkan_11_properties,
    p_next: ?*c_void = null,
    device_uuid: [UUID_SIZE]u8,
    driver_uuid: [UUID_SIZE]u8,
    device_luid: [LUID_SIZE]u8,
...
pub const PhysicalDeviceVulkan12Features = extern struct {
    s_type: StructureType = .physical_device_vulkan_12_features,
    p_next: ?*c_void = null,
...
pub const PhysicalDeviceVulkan12Properties = extern struct {
    s_type: StructureType = .physical_device_vulkan_12_properties,
    p_next: ?*c_void = null,
    driver_id: DriverId,
    driver_name: [MAX_DRIVER_NAME_SIZE]u8,
    driver_info: [MAX_DRIVER_INFO_SIZE]u8,
...
pub const AccelerationStructureBuildGeometryInfoKHR = extern struct {
    ...
    flags: BuildAccelerationStructureFlagsNV,
    update: Bool32,
    src_acceleration_structure: AccelerationStructureNV,
    dst_acceleration_structure: AccelerationStructureNV,
...
pub const AabbPositionsNV = AabbPositionsNV;
pub const TransformMatrixKHR = extern struct {
    matrix: [3][4]f32,
};
pub const TransformMatrixNV = TransformMatrixNV;
pub const AccelerationStructureInstanceKHR = packed struct {
    ...
    flags: u8, // GeometryInstanceFlagsNV
    acceleration_structure_reference: u64,
};
pub const AccelerationStructureInstanceNV = AccelerationStructureInstanceNV;
...
pub const DescriptorType = extern enum {
    ...
    pub const acceleration_structure_nv = .acceleration_structure_nv;
};
pub const QueryType = extern enum {
    ...
    pub const acceleration_structure_compacted_size_nv = .acceleration_structure_compacted_size_nv;
};
...
pub const PipelineBindPoint = extern enum {
    ...
    pub const ray_tracing_nv = .ray_tracing_nv;
};
...
pub const IndexType = extern enum {
    ...
    pub const none_nv = .none_nv;
};
pub const Filter = extern enum {
    nearest = 0,
    linear = 1,
    cubic_img = 1000015000,
    pub const cubic_ext = .cubic_ext;
};
...
pub const StructureType = extern enum {
    ...
    pub const bind_acceleration_structure_memory_info_nv = .bind_acceleration_structure_memory_info_nv;
    pub const write_descriptor_set_acceleration_structure_nv = .write_descriptor_set_acceleration_structure_nv;
    pub const query_pool_create_info_intel = .query_pool_performance_query_create_info_intel;
    pub const physical_device_buffer_address_features_ext = .physical_device_buffer_device_address_features;
...
pub const DebugReportObjectTypeEXT = extern enum {
    ...
    pub const acceleration_structure_nv_ext = .acceleration_structure_khr_ext;
};
...
pub const CopyAccelerationStructureModeKHR = extern enum {
    ...
    serialize_khr = 2,
    deserialize_khr = 3,
    pub const clone_nv = .clone_nv;
    pub const compact_nv = .compact_nv;
};
pub const AccelerationStructureTypeKHR = extern enum {
    top_level_khr = 0,
    bottom_level_khr = 1,
    pub const top_level_nv = .top_level_nv;
    pub const bottom_level_nv = .bottom_level_nv;
};
pub const GeometryTypeKHR = extern enum {
    triangles_khr = 0,
    aabbs_khr = 1,
    instances_khr = 1000150000,
    pub const triangles_nv = .triangles_nv;
    pub const aabbs_nv = .aabbs_nv;
};
pub const AccelerationStructureMemoryRequirementsTypeKHR = extern enum {
    object_khr = 0,
    build_scratch_khr = 1,
    update_scratch_khr = 2,
    pub const object_nv = .object_nv;
    pub const build_scratch_nv = .build_scratch_nv;
    pub const update_scratch_nv = .update_scratch_nv;
};
...
pub const RayTracingShaderGroupTypeKHR = extern enum {
    ...
    pub const general_nv = .general_nv;
    pub const triangles_hit_group_nv = .triangles_hit_group_nv;
    pub const procedural_hit_group_nv = .procedural_hit_group_nv;
};
...
pub const PfnGetPhysicalDeviceExternalImageFormatPropertiesNV = fn (
    ...
    usage: ImageUsageFlags.IntType,
    flags: ImageCreateFlags.IntType,
    external_handle_type: ExternalMemoryHandleTypeFlags.IntType,
    p_external_image_format_properties: *ExternalImageFormatProperties,
) callconv(vulkan_call_conv) Result;
...
pub fn BaseWrapper(comptime Self: type) type {
    return struct {
        pub fn load(loader: PfnGetInstanceProcAddr) !Self {
...
pub fn InstanceWrapper(comptime Self: type) type {
    return struct {
        pub fn load(instance: Instance, loader: PfnGetInstanceProcAddr) !Self {
            var self: Self = undefined;
            inline for (std.meta.fields(Self)) |field| {
                const name = @ptrCast([*:0]const u8, field.name ++ "\x00");
        ...
        pub fn getPhysicalDeviceExternalImageFormatPropertiesNV(
            ...
            usage: ImageUsageFlags,
            flags: ImageCreateFlags,
            external_handle_type: ExternalMemoryHandleTypeFlags,
        ) error{
            OutOfHostMemory,
            OutOfDeviceMemory,
            FormatNotSupported,
            ...
            var external_image_format_properties: ExternalImageFormatProperties = undefined;
        ...
        pub fn getPhysicalDeviceFeatures2(
            ...
            var features: PhysicalDeviceFeatures2 = undefined;
        ...
        pub fn getPhysicalDeviceProperties2(
            ...
            var properties: PhysicalDeviceProperties2 = undefined;
        ...
        pub fn getPhysicalDeviceFormatProperties2(
            ...
            var format_properties: FormatProperties2 = undefined;
        ...
        pub fn getPhysicalDeviceImageFormatProperties2(
            ...
            var image_format_properties: ImageFormatProperties2 = undefined;
        ...
        pub fn getPhysicalDeviceMemoryProperties2(
            ...
            var memory_properties: PhysicalDeviceMemoryProperties2 = undefined;
        ...
        pub fn getPhysicalDeviceExternalBufferProperties(
            ...
            var external_buffer_properties: ExternalBufferProperties = undefined;
        ...
        pub fn getPhysicalDeviceExternalSemaphoreProperties(
            ...
            var external_semaphore_properties: ExternalSemaphoreProperties = undefined;
        ...
        pub fn getPhysicalDeviceExternalFenceProperties(
            ...
            var external_fence_properties: ExternalFenceProperties = undefined;
        ...
        pub fn getPhysicalDeviceSurfaceCapabilities2EXT(
            ...
            var surface_capabilities: SurfaceCapabilities2KHR = undefined;
        ...
        pub fn getPhysicalDeviceMultisamplePropertiesEXT(
            ...
            var multisample_properties: MultisamplePropertiesEXT = undefined;
            self.vkGetPhysicalDeviceMultisamplePropertiesEXT(
                physical_device,
                samples.toInt(),
                &multisample_properties,
            );
            return multisample_properties;
        }
        ...
        pub fn getDisplayPlaneCapabilities2KHR(
            ...
            var capabilities: DisplayPlaneCapabilities2KHR = undefined;
...
pub fn DeviceWrapper(comptime Self: type) type {
    return struct {
        pub fn load(device: Device, loader: PfnGetDeviceProcAddr) !Self {
            var self: Self = undefined;
            inline for (std.meta.fields(Self)) |field| {
                const name = @ptrCast([*:0]const u8, field.name ++ "\x00");
        ...
        pub fn getGeneratedCommandsMemoryRequirementsNV(
            ...
            var memory_requirements: MemoryRequirements2 = undefined;
        ...
        pub fn getMemoryWin32HandlePropertiesKHR(
            ...
            var memory_win_32_handle_properties: MemoryWin32HandlePropertiesKHR = undefined;
            ...
            return memory_win_32_handle_properties;
        }
        ...
        pub fn getMemoryFdPropertiesKHR(
            ...
            var memory_fd_properties: MemoryFdPropertiesKHR = undefined;
        ...
        pub fn getDeviceGroupPresentCapabilitiesKHR(
            ...
            var device_group_present_capabilities: DeviceGroupPresentCapabilitiesKHR = undefined;
        ...
        pub fn getDescriptorSetLayoutSupport(
            ...
            var support: DescriptorSetLayoutSupport = undefined;
        ...
        pub fn getMemoryHostPointerPropertiesEXT(
            ...
            var memory_host_pointer_properties: MemoryHostPointerPropertiesEXT = undefined;
            ...
            return memory_host_pointer_properties;
        }
        ...
        pub fn getAndroidHardwareBufferPropertiesANDROID(
            ...
            var properties: AndroidHardwareBufferPropertiesANDROID = undefined;
        ...
        pub fn getAccelerationStructureMemoryRequirementsKHR(
            ...
            var memory_requirements: MemoryRequirements2 = undefined;
            self.vkGetAccelerationStructureMemoryRequirementsKHR(
                device,
                &info,
                &memory_requirements,
            );
        ...
        pub fn bindAccelerationStructureMemoryKHR(
            ...
            const result = self.vkBindAccelerationStructureMemoryKHR(
                device,
                bind_info_count,
                p_bind_infos,
            );
        ...
        pub fn getDeviceAccelerationStructureCompatibilityKHR(
            ...
            const result = self.vkGetDeviceAccelerationStructureCompatibilityKHR(
                device,
                &version,
            );
            switch (result) {
                .success => {},
                .error_incompatible_version_khr => return error.IncompatibleVersionKHR,
                else => return error.Unknown,
            }
        }
        ...
        pub fn getImageViewAddressNVX(
            ...
            var properties: ImageViewAddressPropertiesNVX = undefined;
        ...
        pub fn getImageDrmFormatModifierPropertiesEXT(
            ...
            device: Device,
            image: Image,
        ) error{Unknown}!ImageDrmFormatModifierPropertiesEXT {
            var properties: ImageDrmFormatModifierPropertiesEXT = undefined;
        ...
        pub fn cmdBuildAccelerationStructureKHR(
            ...
            self.vkCmdBuildAccelerationStructureKHR(
                command_buffer,
                info_count,
                p_infos,
                pp_offset_infos,
        ...
        pub fn cmdBuildAccelerationStructureIndirectKHR(
            ...
            self.vkCmdBuildAccelerationStructureIndirectKHR(
                command_buffer,
                &info,
                indirect_buffer,
                indirect_offset,
        ...
        pub fn buildAccelerationStructureKHR(
            ...
            const result = self.vkBuildAccelerationStructureKHR(
                device,
                info_count,
                p_infos,
                pp_offset_infos,
